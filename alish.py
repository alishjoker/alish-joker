...
wait = {
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"مرسی | طراح ربات علیش جوکر",
    "lang":"JP",
    "comment":"مرسی | طراح ربات علیش جوکر",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"Selamat datang di Alish Family Room")
